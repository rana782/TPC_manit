...
router.get('/placement-dashboard', requireRole(['SPOC', 'COORDINATOR']), getPlacementDashboardBundle);
...
router.get('/branch-report-excel', requireRole(['SPOC', 'COORDINATOR']), exportBranchTimelineExcel);
